...
CREATE TABLE "new_MassProgramSong" (
    ...
    "type" TEXT NOT NULL,
    CONSTRAINT "MassProgramSong_massProgramId_fkey" FOREIGN KEY ("massProgramId") REFERENCES "MassProgram" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "MassProgramSong_songId_fkey" FOREIGN KEY ("songId") REFERENCES "Song" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_MassProgramSong" ("id", "massProgramId", "songId", "type") SELECT "id", "massProgramId", "songId", "type" FROM "MassProgramSong";
