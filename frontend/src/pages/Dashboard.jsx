    ...
    >
      ...
      <div className="dashboard-content">
        ...
        <div className="stats-row">
          {[
            { icon: "📢", value: unreadAnnouncements, label: "Unread Announcements", delay: 0.25 },
            { icon: "⛪", value: upcomingEvents, label: "Upcoming Events", delay: 0.3 },
            { icon: "💬", value: unreadMessages, label: "Unread Messages", delay: 0.35 }
          ].map((stat, idx) => (
            <motion.div 
              key={idx}
              initial={{ y: 20, opacity: 0 }}
