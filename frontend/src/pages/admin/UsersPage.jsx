...
const styles = {
  ...
  exportMenu: { position: "absolute", top: "100%", right: -70, marginTop: "8px", width: "220px", background: "#ffffff", borderRadius: "12px", border: "1px solid #e2e8f0", boxShadow: "0 10px 25px rgba(0,0,0,0.1)", zIndex: 100, overflow: "hidden" },
